...
# Physical left-side allow-list used by the deterministic validator/compiler.
# Relation specs remain semantic; this map is the executable artifact binding.
RELATION_LEFT_SOURCES: dict[str, tuple[str, ...]] = {
    "belongs_to": ("products_clean.csv",),
    "observed_at": ("products_clean.csv",),
    "in_platform_category": ("products_clean.csv",),
    "in_shop_category": ("product_categories_clean.csv",),
    "has_brand": ("products_clean.csv",),
    "observed_promotion_id": ("products_clean.csv",),
    "observed_structured_voucher": ("products_clean.csv",),
    "has_content": ("products_clean.csv",),
    "has_display_variation": ("products_clean.csv",),
    "has_sales_metric": ("products_clean.csv",),
}
